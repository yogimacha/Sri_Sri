...
export function Button({
  ...
  const variants = {
    ...
    secondary: 'bg-gradient-to-r from-accent-500 to-accent-400 text-white hover:from-accent-600 hover:to-accent-500 focus:ring-accent-500 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5',
