...
ADD CONSTRAINT IF NOT EXISTS services_artist_id_fkey 
FOREIGN KEY (artist_id) REFERENCES profiles(id) ON DELETE CASCADE;

ALTER TABLE bookings 
ADD CONSTRAINT IF NOT EXISTS bookings_client_id_fkey 
FOREIGN KEY (client_id) REFERENCES profiles(id) ON DELETE CASCADE;

ALTER TABLE bookings 
ADD CONSTRAINT IF NOT EXISTS bookings_service_id_fkey 
FOREIGN KEY (service_id) REFERENCES services(id) ON DELETE CASCADE;

ALTER TABLE bookings 
ADD CONSTRAINT IF NOT EXISTS bookings_artist_id_fkey 
FOREIGN KEY (artist_id) REFERENCES profiles(id) ON DELETE CASCADE;

ALTER TABLE availability 
ADD CONSTRAINT IF NOT EXISTS availability_artist_id_fkey 
FOREIGN KEY (artist_id) REFERENCES profiles(id) ON DELETE CASCADE;
...
CREATE TRIGGER IF NOT EXISTS on_services_updated
  BEFORE UPDATE ON services
  FOR EACH ROW EXECUTE FUNCTION handle_updated_at();

CREATE TRIGGER IF NOT EXISTS on_bookings_updated
  BEFORE UPDATE ON bookings
  FOR EACH ROW EXECUTE FUNCTION handle_updated_at();

CREATE TRIGGER IF NOT EXISTS on_availability_updated
