...
-- Create policies using DO blocks to check existence
DO $$
BEGIN
  -- Services policies
  IF NOT EXISTS (
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public' 
    AND tablename = 'services' 
    AND policyname = 'Artists can insert their own services'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public' 
    AND tablename = 'services' 
    AND policyname = 'Artists can update their own services'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public' 
    AND tablename = 'services' 
    AND policyname = 'Artists can delete their own services'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public' 
    AND tablename = 'bookings' 
    AND policyname = 'Artists and clients can update their bookings'
  ) THEN
  ...
  IF NOT EXISTS (
    ...
    WHERE schemaname = 'public' 
    AND tablename = 'availability' 
    AND policyname = 'Artists can manage their own availability'
  ) THEN
